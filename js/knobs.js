...
class Knob {
  constructor({
    ...
    this.imagePath = 'images/knob_Images/'; // Updated image path
    ...
    this.imgFile = `${this.type}/${this.type}_${this.size}.png`; // Image file name
  ...
  setUpKnob() {
    ...
    let src = this.imagePath + this.imgFile; // Use local image path
